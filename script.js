...
const slider = function () {
  ...
  const goToSlide = function (slide) {
    slides.forEach((s, i) => {
      s.style.transform = `translateX(${100 * (i - slide)}vw)`;
    });
  };
...
// // we can create HTML elements using insertAdjacentHtml
// // .insertAdjacentHtml
...
//     // message.remove();
//     message.parentElement.removeChild(document.querySelector(''));
//   });
